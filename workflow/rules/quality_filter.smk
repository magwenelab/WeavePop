...
rule bam_good:
    ...
    output:
        ...
        bai_good=temp(
            INT_SAMPLES_DIR / "depth_quality" / "{unf_sample}" / "snps_good.bam.bai"
        ),
    params:
...
rule join_mapping_stats:
    ...
    params:
        min_depth=config["depth_quality"]["flag_quality"]["min_genome-wide_depth"],
...
# =================================================================================================
#   All references | Obtain chromosome lengths
# =================================================================================================
