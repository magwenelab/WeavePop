...
print("Reading files")
# depth_windows <- read.delim("results_230724/samples/mosdepth/PMY3315/depth_by_windows.tsv", sep= "\t", col.names = c("Accession", "Start", "End", "Depth", "Norm_Depth", "Smooth_Depth"), stringsAsFactors = TRUE, na = c("", "N/A"))
