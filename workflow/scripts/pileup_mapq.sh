...
gunzip ${snakemake_input[1]}  --stdout 2>> ${snakemake_log[0]} | cut -f1,2,3 2>> ${snakemake_log[0]} | bedtools map -a - -b ${snakemake_output[0]} -c 3 -o mean -null 0 > ${snakemake_output[1]} 2>> ${snakemake_log[0]}