...
if ("strain" %in% colnames(metadata)){
  ...
  sub = paste("Sample:", samp, "Strain:", strain_name, " Reference genome:", ref_genome_name, " Window size:", window_size, " Total variants: ", scales::comma(n_vars))
} else {
  print("Strain name not provided")
  sub = paste("Sample:", samp, " Reference genome:", ref_genome_name, " Window size:", window_size, " Total variants: ", scales::comma(n_vars))
}
...
if ("strain" %in% colnames(metadata)){
  print("Strain name provided")
  sub = paste("Sample:", samp, "Strain:", strain_name, " Reference genome:", ref_genome_name, " Total variants: ", scales::comma(n_vars))
} else {
  print("Strain name not provided")
  sub = paste("Sample:", samp, " Reference genome:", ref_genome_name, " Total variants: ", scales::comma(n_vars))
}
